            ...
            <div class="w-auto">
              ...
              >
                ...
                <li class="mx-3 py-6 md:py-0">
                  <a href="#" class="text-black hover:bg-black rounded-full px-2 py-3 inline-block flex-none transition duration-200 {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black ' }} "
                    >Catalog</a
                  >
                </li>
                @auth
                ...
                @guest
                <li class="mx-3 py-6 md:py-0">
                  <a href="{{ route('login') }}" class="text-black  hover:bg-black rounded-full px-2 py-3 inline-block flex-none transition duration-200 {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'}}"
                    >Login</a
                  >
                </li>
                <li class="mx-3 py-6 md:py-0">
                  <a href="{{ route('register') }}" class="text-black hover:bg-black rounded-full px-2 py-3 inline-block flex-none transition duration-200 {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} "
                    >Register</a
                  >
                </li>
                @endguest
