...
@section('content')
    ...
    <section class="flex items-center hero">
        ...
        >
          <h1 class="text-3xl text-yellow-700 md:text-5xl leading-tight font-semibold ">
            Keripik Kentang <br class="" />Kurauk Sakhiya
          </h1>
          <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
            Renyahnya keripik kentang dengan tekstur yang
            <br class="hidden lg:block" />gurih membuat keripik kentang semakin enak.
          </h2>
        </div>
        ...
        <div class="container mx-auto">
          <div class="flex flex-start mb-4">
            <h3 class="text-2xl capitalize font-semibold">
              Pilih Kategori <br class="" />Memiliki berbagai macam rasa
            </h3>
          </div>
          <div class="grid grid-rows-2 grid-cols-9 gap-4">
            ...
            >
              ...
              >
                <h5 class="text-white text-lg font-semibold">Rasa Mercon (Pedas)</h5>
                <span class="">3 items</span>
              </div>
          ...
          >
            ...
            >
              <h5 class="text-lg font-semibold">Rasa Balado</h5>
              <span class="">3 items</span>
            </div>
            <a href="#" class="stretched-link">
              <!-- fake children -->
            ...
            <div class="relative col-span-9 row-span-1 md:col-span-4 card">
              ...
              <div
                class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72"
              >
                <h5 class="text-lg font-semibold">Rasa Original</h5>
                <span class="">2 items</span>
              </div>
              <a href="#" class="stretched-link">
                <!-- fake children -->
              </a>
